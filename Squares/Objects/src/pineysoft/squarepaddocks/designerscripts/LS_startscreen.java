...
views.get("pnlshading").vw.setTop((int)((20d / 100 * height)));
views.get("pnlshading").vw.setHeight((int)((80d / 100 * height) - ((20d / 100 * height))));
...
views.get("lblplayers").vw.setHeight((int)(((views.get("pnlselectionleft").vw.getHeight())-70d)/7d));
views.get("lblplayers").vw.setTop((int)((10d * scale)));
...
views.get("lbldroids").vw.setTop((int)((views.get("lblplayers").vw.getTop() + views.get("lblplayers").vw.getHeight())+(10d * scale)));
...
views.get("lblrows").vw.setTop((int)((views.get("lbldroids").vw.getTop() + views.get("lbldroids").vw.getHeight())+(10d * scale)));
...
views.get("lblcolumns").vw.setTop((int)((views.get("lblrows").vw.getTop() + views.get("lblrows").vw.getHeight())+(10d * scale)));
//BA.debugLineNum = 40;BA.debugLine="lblColumns.Height = lblPlayers.Height"[startscreen/General script]
views.get("lblcolumns").vw.setHeight((int)((views.get("lblplayers").vw.getHeight())));
//BA.debugLineNum = 41;BA.debugLine="lblColumns.Right = pnlSelectionLeft.Width"[startscreen/General script]
views.get("lblcolumns").vw.setLeft((int)((views.get("pnlselectionleft").vw.getWidth()) - (views.get("lblcolumns").vw.getWidth())));
//BA.debugLineNum = 43;BA.debugLine="lblSound.Width = lblDroids.Width"[startscreen/General script]
views.get("lblsound").vw.setWidth((int)((views.get("lbldroids").vw.getWidth())));
//BA.debugLineNum = 44;BA.debugLine="lblSound.Top = lblColumns.Bottom + 10dip"[startscreen/General script]
views.get("lblsound").vw.setTop((int)((views.get("lblcolumns").vw.getTop() + views.get("lblcolumns").vw.getHeight())+(10d * scale)));
...
//BA.debugLineNum = 49;BA.debugLine="lblDifficulty.Top = lblSound.Bottom + 10dip"[startscreen/General script]
views.get("lbldifficulty").vw.setTop((int)((views.get("lblsound").vw.getTop() + views.get("lblsound").vw.getHeight())+(10d * scale)));
...
//BA.debugLineNum = 54;BA.debugLine="spnPlayers.Left = 0dip"[startscreen/General script]
views.get("spnplayers").vw.setLeft((int)((0d * scale)));
//BA.debugLineNum = 55;BA.debugLine="spnPlayers.Top = lblPlayers.Top"[startscreen/General script]
views.get("spnplayers").vw.setTop((int)((views.get("lblplayers").vw.getTop())));
//BA.debugLineNum = 56;BA.debugLine="spnPlayers.Width = lblPlayers.Width"[startscreen/General script]
views.get("spnplayers").vw.setWidth((int)((views.get("lblplayers").vw.getWidth())));
//BA.debugLineNum = 57;BA.debugLine="spnPlayers.Height = lblPlayers.Height"[startscreen/General script]
views.get("spnplayers").vw.setHeight((int)((views.get("lblplayers").vw.getHeight())));
//BA.debugLineNum = 59;BA.debugLine="spnDroids.Top = lblDroids.Top"[startscreen/General script]
views.get("spndroids").vw.setTop((int)((views.get("lbldroids").vw.getTop())));
//BA.debugLineNum = 60;BA.debugLine="spnDroids.Left = 0dip"[startscreen/General script]
views.get("spndroids").vw.setLeft((int)((0d * scale)));
//BA.debugLineNum = 61;BA.debugLine="spnDroids.Width = lblRows.Width"[startscreen/General script]
views.get("spndroids").vw.setWidth((int)((views.get("lblrows").vw.getWidth())));
//BA.debugLineNum = 62;BA.debugLine="spnDroids.Height  = lblPlayers.Height"[startscreen/General script]
views.get("spndroids").vw.setHeight((int)((views.get("lblplayers").vw.getHeight())));
//BA.debugLineNum = 64;BA.debugLine="sbRows.Top = lblRows.Top"[startscreen/General script]
views.get("sbrows").vw.setTop((int)((views.get("lblrows").vw.getTop())));
//BA.debugLineNum = 65;BA.debugLine="sbRows.Left = 0dip"[startscreen/General script]
views.get("sbrows").vw.setLeft((int)((0d * scale)));
//BA.debugLineNum = 66;BA.debugLine="sbRows.Width = lblRows.Width"[startscreen/General script]
views.get("sbrows").vw.setWidth((int)((views.get("lblrows").vw.getWidth())));
//BA.debugLineNum = 67;BA.debugLine="sbRows.Height = lblPlayers.Height"[startscreen/General script]
views.get("sbrows").vw.setHeight((int)((views.get("lblplayers").vw.getHeight())));
//BA.debugLineNum = 69;BA.debugLine="sbColumns.Top = lblColumns.Top"[startscreen/General script]
views.get("sbcolumns").vw.setTop((int)((views.get("lblcolumns").vw.getTop())));
//BA.debugLineNum = 70;BA.debugLine="sbColumns.Left = 0dip"[startscreen/General script]
views.get("sbcolumns").vw.setLeft((int)((0d * scale)));
//BA.debugLineNum = 71;BA.debugLine="sbColumns.Width = lblColumns.Width"[startscreen/General script]
views.get("sbcolumns").vw.setWidth((int)((views.get("lblcolumns").vw.getWidth())));
//BA.debugLineNum = 72;BA.debugLine="sbColumns.Height  = lblPlayers.Height"[startscreen/General script]
views.get("sbcolumns").vw.setHeight((int)((views.get("lblplayers").vw.getHeight())));
//BA.debugLineNum = 74;BA.debugLine="chkSounds.Top = lblSound.Top"[startscreen/General script]
views.get("chksounds").vw.setTop((int)((views.get("lblsound").vw.getTop())));
//BA.debugLineNum = 75;BA.debugLine="chkSounds.Left = 0dip"[startscreen/General script]
views.get("chksounds").vw.setLeft((int)((0d * scale)));
//BA.debugLineNum = 76;BA.debugLine="chkSounds.Height = lblColumns.Height"[startscreen/General script]
views.get("chksounds").vw.setHeight((int)((views.get("lblcolumns").vw.getHeight())));
//BA.debugLineNum = 77;BA.debugLine="chkSounds.Width = 40dip"[startscreen/General script]
views.get("chksounds").vw.setWidth((int)((40d * scale)));
//BA.debugLineNum = 79;BA.debugLine="spnDifficulty.Top = lblDifficulty.Top"[startscreen/General script]
views.get("spndifficulty").vw.setTop((int)((views.get("lbldifficulty").vw.getTop())));
//BA.debugLineNum = 80;BA.debugLine="spnDifficulty.Height = lblDifficulty.Height"[startscreen/General script]
views.get("spndifficulty").vw.setHeight((int)((views.get("lbldifficulty").vw.getHeight())));
//BA.debugLineNum = 81;BA.debugLine="spnDifficulty.Width = lblDifficulty.Width"[startscreen/General script]
views.get("spndifficulty").vw.setWidth((int)((views.get("lbldifficulty").vw.getWidth())));
//BA.debugLineNum = 85;BA.debugLine="If 100%y - (pnlShading.Bottom + 10dip) > 80dip Then"[startscreen/General script]
if (((100d / 100 * height)-((views.get("pnlshading").vw.getTop() + views.get("pnlshading").vw.getHeight())+(10d * scale))>(80d * scale))) { 
;
//BA.debugLineNum = 86;BA.debugLine="btnContinue.Height = 80dip"[startscreen/General script]
views.get("btncontinue").vw.setHeight((int)((80d * scale)));
//BA.debugLineNum = 87;BA.debugLine="Else"[startscreen/General script]
;}else{ 
;
//BA.debugLineNum = 88;BA.debugLine="btnContinue.Height = 100%y - (pnlShading.Bottom + 10dip)"[startscreen/General script]
...
//BA.debugLineNum = 89;BA.debugLine="End If"[startscreen/General script]
;};
//BA.debugLineNum = 90;BA.debugLine="btnContinue.Width = 25%x"[startscreen/General script]
views.get("btncontinue").vw.setWidth((int)((25d / 100 * width)));
//BA.debugLineNum = 91;BA.debugLine="btnContinue.HorizontalCenter = 50%x"[startscreen/General script]
views.get("btncontinue").vw.setLeft((int)((50d / 100 * width) - (views.get("btncontinue").vw.getWidth() / 2)));
//BA.debugLineNum = 92;BA.debugLine="btnContinue.Bottom = 100%y - 10dip"[startscreen/General script]
views.get("btncontinue").vw.setTop((int)((100d / 100 * height)-(10d * scale) - (views.get("btncontinue").vw.getHeight())));
//BA.debugLineNum = 94;BA.debugLine="icon1.Left = -100dip"[startscreen/General script]
views.get("icon1").vw.setLeft((int)(0-(100d * scale)));
//BA.debugLineNum = 95;BA.debugLine="icon2.Left = -100dip"[startscreen/General script]
views.get("icon2").vw.setLeft((int)(0-(100d * scale)));
//BA.debugLineNum = 96;BA.debugLine="icon3.Left = -100dip"[startscreen/General script]
views.get("icon3").vw.setLeft((int)(0-(100d * scale)));
//BA.debugLineNum = 97;BA.debugLine="icon4.Left = -100dip"[startscreen/General script]
views.get("icon4").vw.setLeft((int)(0-(100d * scale)));
//BA.debugLineNum = 98;BA.debugLine="icon5.Left = -120dip"[startscreen/General script]
views.get("icon5").vw.setLeft((int)(0-(120d * scale)));
//BA.debugLineNum = 99;BA.debugLine="icon6.Left = -120dip"[startscreen/General script]
