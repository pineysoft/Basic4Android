...
//BA.debugLineNum = 44;BA.debugLine="txtMessage.Top = btnCurrPlayer.Top"[layout1/General script]
views.get("txtmessage").vw.setTop((int)((views.get("btncurrplayer").vw.getTop())));
//BA.debugLineNum = 45;BA.debugLine="txtMessage.Left = btnCurrPlayer.Right + 1dip"[layout1/General script]
views.get("txtmessage").vw.setLeft((int)((views.get("btncurrplayer").vw.getLeft() + views.get("btncurrplayer").vw.getWidth())+(1d * scale)));
//BA.debugLineNum = 46;BA.debugLine="txtMessage.Height = btnCurrPlayer.Height"[layout1/General script]
views.get("txtmessage").vw.setHeight((int)((views.get("btncurrplayer").vw.getHeight())));
//BA.debugLineNum = 47;BA.debugLine="txtMessage.Width = lblPlayer4.Width + lblPlayer4Image.Width"[layout1/General script]
views.get("txtmessage").vw.setWidth((int)((views.get("lblplayer4").vw.getWidth())+(views.get("lblplayer4image").vw.getWidth())));
//BA.debugLineNum = 49;BA.debugLine="Panel1.Width = 100%x"[layout1/General script]
views.get("panel1").vw.setWidth((int)((100d / 100 * width)));
//BA.debugLineNum = 50;BA.debugLine="Panel1.Height = lblPlayer1.Top - 2dip"[layout1/General script]
views.get("panel1").vw.setHeight((int)((views.get("lblplayer1").vw.getTop())-(2d * scale)));
//BA.debugLineNum = 51;BA.debugLine="Panel1.Bottom = lblPlayer1Image.Top - 2dip"[layout1/General script]
