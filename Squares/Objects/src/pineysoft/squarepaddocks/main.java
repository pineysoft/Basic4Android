...
public static short _vvvvvvvvvv7 = (short)0;
public static int _vvvvvvvvvvvvv4 = 0;
public static int _vvvvvvvvvvvvv5 = 0;
public static anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvv2 = null;
public static boolean _vvvvvvv4 = false;
...
public pineysoft.squarepaddocks.gamesquare[][] _vvvvvvvvvvvvv1 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvvv6 = null;
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper _vvvvvvvvvvv1 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvv6 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvvv7 = null;
public anywheresoftware.b4a.objects.collections.List _vvvvvvvvvvvv3 = null;
...
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvv6 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvv0 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvv2 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvv4 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvv6 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvv0 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvvvv2 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvvv6 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvvv0 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvvv3 = null;
public flm.b4a.animationplus.AnimationPlusWrapper _vvvvvvvvv4 = null;
...
mostCurrent._vvvvvvv6.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (75),mostCurrent.activityBA)+(mostCurrent._icon1.getWidth()/(double)2)),(float) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA)-_vvvvvvv7));
 //BA.debugLineNum = 141;BA.debugLine="anim1.Duration = 1000";
mostCurrent._vvvvvvv6.setDuration((long) (1000));
 //BA.debugLineNum = 142;BA.debugLine="anim1.StartOffset = 0";
mostCurrent._vvvvvvv6.setStartOffset((long) (0));
 //BA.debugLineNum = 143;BA.debugLine="anim1.PersistAfter = False";
mostCurrent._vvvvvvv6.setPersistAfter(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 144;BA.debugLine="anim1.Start(icon1)";
mostCurrent._vvvvvvv6.Start((android.view.View)(mostCurrent._icon1.getObject()));
 //BA.debugLineNum = 145;BA.debugLine="anim2.InitializeTranslate(\"\", 0,0,-(75%x+(icon2.width/2)),45%y-start2)";
mostCurrent._vvvvvvv0.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (-(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (75),mostCurrent.activityBA)+(mostCurrent._icon2.getWidth()/(double)2))),(float) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA)-_vvvvvvvv1));
 //BA.debugLineNum = 146;BA.debugLine="anim2.Duration = 1000";
mostCurrent._vvvvvvv0.setDuration((long) (1000));
 //BA.debugLineNum = 147;BA.debugLine="anim2.StartOffset = 0";
mostCurrent._vvvvvvv0.setStartOffset((long) (0));
 //BA.debugLineNum = 148;BA.debugLine="anim2.PersistAfter = False";
mostCurrent._vvvvvvv0.setPersistAfter(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 149;BA.debugLine="anim2.Start(icon2)";
mostCurrent._vvvvvvv0.Start((android.view.View)(mostCurrent._icon2.getObject()));
 //BA.debugLineNum = 150;BA.debugLine="anim3.InitializeTranslate(\"\", 0,0,50%x+(icon3.width/2),25%y-start3)";
mostCurrent._vvvvvvvv2.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)+(mostCurrent._icon3.getWidth()/(double)2)),(float) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA)-_vvvvvvvv3));
 //BA.debugLineNum = 151;BA.debugLine="anim3.Duration = 1000";
mostCurrent._vvvvvvvv2.setDuration((long) (1000));
 //BA.debugLineNum = 152;BA.debugLine="anim3.StartOffset = 0";
mostCurrent._vvvvvvvv2.setStartOffset((long) (0));
 //BA.debugLineNum = 153;BA.debugLine="anim3.PersistAfter = False";
mostCurrent._vvvvvvvv2.setPersistAfter(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 154;BA.debugLine="anim3.Start(icon3)";
mostCurrent._vvvvvvvv2.Start((android.view.View)(mostCurrent._icon3.getObject()));
 //BA.debugLineNum = 155;BA.debugLine="anim4.InitializeTranslate(\"\", 0,0,-(50%x+(icon4.width/2)),45%y-start4)";
mostCurrent._vvvvvvvv4.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (-(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)+(mostCurrent._icon4.getWidth()/(double)2))),(float) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA)-_vvvvvvvv5));
 //BA.debugLineNum = 156;BA.debugLine="anim4.Duration = 1000";
mostCurrent._vvvvvvvv4.setDuration((long) (1000));
 //BA.debugLineNum = 157;BA.debugLine="anim4.StartOffset = 0";
mostCurrent._vvvvvvvv4.setStartOffset((long) (0));
 //BA.debugLineNum = 158;BA.debugLine="anim4.PersistAfter	 = False";
mostCurrent._vvvvvvvv4.setPersistAfter(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 159;BA.debugLine="anim4.Start(icon4)";
mostCurrent._vvvvvvvv4.Start((android.view.View)(mostCurrent._icon4.getObject()));
 //BA.debugLineNum = 160;BA.debugLine="anim5.InitializeTranslate(\"\", 0,0,25%x+(icon5.width/2),25%y-start5)";
mostCurrent._vvvvvvvv6.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (25),mostCurrent.activityBA)+(mostCurrent._icon5.getWidth()/(double)2)),(float) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA)-_vvvvvvvv7));
 //BA.debugLineNum = 161;BA.debugLine="anim5.Duration = 1000";
mostCurrent._vvvvvvvv6.setDuration((long) (1000));
 //BA.debugLineNum = 162;BA.debugLine="anim5.StartOffset = 0";
mostCurrent._vvvvvvvv6.setStartOffset((long) (0));
 //BA.debugLineNum = 163;BA.debugLine="anim5.PersistAfter = False";
mostCurrent._vvvvvvvv6.setPersistAfter(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 164;BA.debugLine="anim5.Start(icon5)";
mostCurrent._vvvvvvvv6.Start((android.view.View)(mostCurrent._icon5.getObject()));
 //BA.debugLineNum = 165;BA.debugLine="anim6.InitializeTranslate(\"LastIcon\", 0,0,-(25%x+(icon6.width/2)),45%y-start6)";
mostCurrent._vvvvvvvv0.InitializeTranslate(mostCurrent.activityBA,"LastIcon",(float) (0),(float) (0),(float) (-(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (25),mostCurrent.activityBA)+(mostCurrent._icon6.getWidth()/(double)2))),(float) (anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA)-_vvvvvvvvv1));
 //BA.debugLineNum = 166;BA.debugLine="anim6.Duration = 1000";
mostCurrent._vvvvvvvv0.setDuration((long) (1000));
 //BA.debugLineNum = 167;BA.debugLine="anim6.StartOffset = 0";
mostCurrent._vvvvvvvv0.setStartOffset((long) (0));
 //BA.debugLineNum = 168;BA.debugLine="anim6.PersistAfter = False";
mostCurrent._vvvvvvvv0.setPersistAfter(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 169;BA.debugLine="anim6.Start(icon6)";
mostCurrent._vvvvvvvv0.Start((android.view.View)(mostCurrent._icon6.getObject()));
...
mostCurrent._vvvvvvvvv3.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (-anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)),(float) (0));
 //BA.debugLineNum = 214;BA.debugLine="animStartScr.Duration = 400";
mostCurrent._vvvvvvvvv3.setDuration((long) (400));
...
mostCurrent._vvvvvvvvv3.Start((android.view.View)(mostCurrent._pnlstartscreen.getObject()));
 //BA.debugLineNum = 218;BA.debugLine="AnimGameScr.InitializeTranslate(\"GameScr\",100%x,0,0,0)";
mostCurrent._vvvvvvvvv4.InitializeTranslate(mostCurrent.activityBA,"GameScr",(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)),(float) (0),(float) (0),(float) (0));
 //BA.debugLineNum = 219;BA.debugLine="AnimGameScr.Duration = 400";
mostCurrent._vvvvvvvvv4.setDuration((long) (400));
 //BA.debugLineNum = 220;BA.debugLine="AnimGameScr.PersistAfter = True";
mostCurrent._vvvvvvvvv4.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 221;BA.debugLine="AnimGameScr.Start(pnlBase)";
mostCurrent._vvvvvvvvv4.Start((android.view.View)(mostCurrent._pnlbase.getObject()));
...
mostCurrent._vvvvvvvvv6.InitializeTranslate(mostCurrent.activityBA,"LeftPanel",(float) (-(mostCurrent._pnlselectionleft.getWidth())),(float) (0),(float) (mostCurrent._pnlselectionleft.getWidth()+anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (5),mostCurrent.activityBA)),(float) (0));
 //BA.debugLineNum = 289;BA.debugLine="animPanel1.PersistAfter = True";
mostCurrent._vvvvvvvvv6.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 290;BA.debugLine="animPanel1.Duration = 500";
mostCurrent._vvvvvvvvv6.setDuration((long) (500));
 //BA.debugLineNum = 291;BA.debugLine="animPanel1.Start(pnlSelectionLeft)";
mostCurrent._vvvvvvvvv6.Start((android.view.View)(mostCurrent._pnlselectionleft.getObject()));
...
mostCurrent._vvvvvvvvv0.InitializeTranslate(mostCurrent.activityBA,"RightPanel",(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)),(float) (0),(float) (-anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (45),mostCurrent.activityBA)),(float) (0));
 //BA.debugLineNum = 301;BA.debugLine="animPanel2.PersistAfter = True";
mostCurrent._vvvvvvvvv0.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 302;BA.debugLine="animPanel2.Duration = 500";
mostCurrent._vvvvvvvvv0.setDuration((long) (500));
 //BA.debugLineNum = 303;BA.debugLine="animPanel2.Start(pnlSelectionRight)";
mostCurrent._vvvvvvvvv0.Start((android.view.View)(mostCurrent._pnlselectionright.getObject()));
...
mostCurrent._vvvvvvvvvv2.InitializeScaleCenter(mostCurrent.activityBA,"Shading",(float) (0.1),(float) (0.1),(float) (1),(float) (1),(android.view.View)(mostCurrent._pnlshading.getObject()));
 //BA.debugLineNum = 276;BA.debugLine="animShading.Duration = 750";
mostCurrent._vvvvvvvvvv2.setDuration((long) (750));
...
mostCurrent._vvvvvvvvvv2.Start((android.view.View)(mostCurrent._pnlshading.getObject()));
...
public static String  _vvvvvvvvvv4(int _xcoord,int _ycoord) throws Exception{
...
_currentsquare = _vvvvvvvvvv5(_xcoord,_ycoord);
 //BA.debugLineNum = 507;BA.debugLine="Dim currPlayer As Player = players.Get(currentPlayer)";
_currplayer = (pineysoft.squarepaddocks.player)(mostCurrent._vvvvvvvvvv6.Get((int) (_vvvvvvvvvv7)));
 //BA.debugLineNum = 509;BA.debugLine="chosenSide = currentSquare.CalculateClosestEdge(touchPoint)";
_chosenside = _currentsquare._vvv5(_touchpoint);
...
mostCurrent._btncurrplayer.SetBackgroundImage((android.graphics.Bitmap)(_currplayer._vvv1.getObject()));
...
while (_currplayer._vvv2==_v6._player_type_droid) {
...
public static boolean  _vvvvvvvvvvv0() throws Exception{
int _iloop = 0;
String _scoretext = "";
...
{
final int step543 = 1;
final int limit543 = (int) (mostCurrent._vvvvvvvvvv6.getSize()-1);
...
if (_totalscore==_vvvvvvvvvvvv1*_vvvvvvvvvvvv2) { 
...
_currplayer = (pineysoft.squarepaddocks.player)(mostCurrent._vvvvvvvvvv6.Get(_winnernum));
 //BA.debugLineNum = 657;BA.debugLine="imageIcon.Bitmap = currPlayer.PlayerImage";
mostCurrent._imageicon.setBitmap((android.graphics.Bitmap)(_currplayer._vvv1.getObject()));
...
{
final int step567 = 1;
final int limit567 = mostCurrent._vvvvvvvvvv6.getSize();
...
_p = (pineysoft.squarepaddocks.player)(mostCurrent._vvvvvvvvvv6.Get((int) (_iloop-1)));
 //BA.debugLineNum = 668;BA.debugLine="scoreText = scoreText & \"Player \" & iLoop & \": \" & p.Score & \" \"";
_scoretext = _scoretext+"Player "+BA.NumberToString(_iloop)+": "+BA.NumberToString(_p._vv7)+" ";
 }
};
...
mostCurrent._chksounds.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._vvvvvvvvvvvv3.Get(_v6._checkbox_off)));
...
mostCurrent._chksounds.SetBackgroundImage((android.graphics.Bitmap)(mostCurrent._vvvvvvvvvvvv3.Get(_v6._checkbox_on)));
...
public static int  _vvvvvvvvvvv3(pineysoft.squarepaddocks.player _currplayer) throws Exception{
...
_allclosed = _vvvvvvvvvvvv4((int) (4));
...
if (_item._vvvvv5==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 1142;BA.debugLine="FillTheSquare(item, currPlayer)";
_vvvvvvvvvvvv5(_item,_currplayer);
...
_item._vvvvv5 = anywheresoftware.b4a.keywords.Common.True;
 };
 }
;
...
_x = (int) (_vvvvvvvvvvvv7/(double)2);
 //BA.debugLineNum = 461;BA.debugLine="Dim y As Int = rowSpacing / 2";
_y = (int) (_vvvvvvvvvvvv0/(double)2);
 //BA.debugLineNum = 462;BA.debugLine="Dim gameSquares(gameHeight,gameWidth) As GameSquare";
mostCurrent._vvvvvvvvvvvvv1 = new pineysoft.squarepaddocks.gamesquare[_vvvvvvvvvvvv2][];
{
int d0 = mostCurrent._vvvvvvvvvvvvv1.length;
int d1 = _vvvvvvvvvvvv1;
for (int i0 = 0;i0 < d0;i0++) {
mostCurrent._vvvvvvvvvvvvv1[i0] = new pineysoft.squarepaddocks.gamesquare[d1];
for (int i1 = 0;i1 < d1;i1++) {
mostCurrent._vvvvvvvvvvvvv1[i0][i1] = new pineysoft.squarepaddocks.gamesquare();
}
}
}
;
...
{
final int step399 = 1;
final int limit399 = (int) (_vvvvvvvvvvvv2-1);
...
{
final int step400 = 1;
final int limit400 = (int) (_vvvvvvvvvvvv1-1);
...
_square._initialize(mostCurrent.activityBA,_x,_y,_vvvvvvvvvvvv7,_vvvvvvvvvvvv0,_rowloop,_colloop);
 //BA.debugLineNum = 471;BA.debugLine="square.fillLabel = lblSquare";
_square._vvvvv7 = _lblsquare;
...
mostCurrent._panel1.AddView((android.view.View)(_lblsquare.getObject()),(int) (_square._vvvv0._vv2+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_square._vvvv0._vv3+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_vvvvvvvvvvvv7-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8))),(int) (_vvvvvvvvvvvv0-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8))));
 //BA.debugLineNum = 473;BA.debugLine="gameSquares(rowLoop, colLoop) = square";
mostCurrent._vvvvvvvvvvvvv1[_rowloop][_colloop] = _square;
 //BA.debugLineNum = 474;BA.debugLine="x = x + columnSpacing";
_x = (int) (_x+_vvvvvvvvvvvv7);
 }
};
 //BA.debugLineNum = 476;BA.debugLine="x = columnSpacing / 2";
_x = (int) (_vvvvvvvvvvvv7/(double)2);
 //BA.debugLineNum = 477;BA.debugLine="y = y + rowSpacing";
_y = (int) (_y+_vvvvvvvvvvvv0);
 }
};
...
_vvvvvvvvvvvvv2.Initialize();
 //BA.debugLineNum = 319;BA.debugLine="playerColours.Add(Colors.Yellow)";
_vvvvvvvvvvvvv2.Add((Object)(anywheresoftware.b4a.keywords.Common.Colors.Yellow));
 //BA.debugLineNum = 320;BA.debugLine="playerColours.Add(Colors.Blue)";
_vvvvvvvvvvvvv2.Add((Object)(anywheresoftware.b4a.keywords.Common.Colors.Blue));
 //BA.debugLineNum = 321;BA.debugLine="playerColours.Add(Colors.Green)";
_vvvvvvvvvvvvv2.Add((Object)(anywheresoftware.b4a.keywords.Common.Colors.Green));
 //BA.debugLineNum = 322;BA.debugLine="playerColours.Add(Colors.Red)";
_vvvvvvvvvvvvv2.Add((Object)(anywheresoftware.b4a.keywords.Common.Colors.Red));
...
mostCurrent._vvvvvvvvvv6.Initialize();
...
{
final int step318 = 1;
final int limit318 = _vvvvvvvvvvvvv4;
...
_playerval._initialize(processBA,"Player "+BA.NumberToString(_iloop),(int)(BA.ObjectToNumber(_vvvvvvvvvvvvv2.Get((int) (_iloop-1)))));
 //BA.debugLineNum = 376;BA.debugLine="If iLoop <= numberOfPlayers - numberOfDroids Then";
if (_iloop<=_vvvvvvvvvvvvv4-_vvvvvvvvvvvvv5) { 
 //BA.debugLineNum = 377;BA.debugLine="playerVal.PlayerType = SPConstants.PLAYER_TYPE_HUMAN";
_playerval._vvv2 = _v6._player_type_human;
 }else {
 //BA.debugLineNum = 379;BA.debugLine="playerVal.PlayerType = SPConstants.PLAYER_TYPE_DROID";
_playerval._vvv2 = _v6._player_type_droid;
 };
 //BA.debugLineNum = 381;BA.debugLine="Dim v As View = GetViewByTag1(pnlBase, \"P\" & iLoop)";
_v = new anywheresoftware.b4a.objects.ConcreteViewWrapper();
_v = _vvvvvvvvvvvvv6((anywheresoftware.b4a.objects.ActivityWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ActivityWrapper(), (anywheresoftware.b4a.BALayout)(mostCurrent._pnlbase.getObject())),"P"+BA.NumberToString(_iloop));
...
if (_playerval._vvv2==_v6._player_type_human) { 
...
if (_iloop<=mostCurrent._vvvvvvvvvvvvv7.getSize()) { 
...
_vimage = _vvvvvvvvvvvvv6((anywheresoftware.b4a.objects.ActivityWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ActivityWrapper(), (anywheresoftware.b4a.BALayout)(mostCurrent._pnlbase.getObject())),"I"+BA.NumberToString(_iloop));
...
_imagenum = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),(int) (mostCurrent._vvvvvvvvvvvvv7.getSize()-1));
...
_playerval._vvv1.setObject((android.graphics.Bitmap)(mostCurrent._vvvvvvvvvvvvv7.Get(_imagenum)));
 //BA.debugLineNum = 399;BA.debugLine="lblImage.SetBackgroundImage(playerVal.PlayerImage)";
_lblimage.SetBackgroundImage((android.graphics.Bitmap)(_playerval._vvv1.getObject()));
 //BA.debugLineNum = 400;BA.debugLine="If playerVal.PlayerType = SPConstants.PLAYER_TYPE_DROID Then";
if (_playerval._vvv2==_v6._player_type_droid) { 
...
mostCurrent._vvvvvvvvvv6.Add((Object)(_playerval));
 }
};
 //BA.debugLineNum = 408;BA.debugLine="currentPlayer = 0";
_vvvvvvvvvv7 = (short) (0);
...
_text = _text+BA.NumberToString(_item.square._vvvv7)+", "+BA.NumberToString(_item.square._vvvv6)+" : "+BA.NumberToString(_item.chainCount)+anywheresoftware.b4a.keywords.Common.CRLF;
 }
;
...
_vvvvvvv4 = anywheresoftware.b4a.keywords.Common.False;
...
{
final int step417 = 1;
final int limit417 = (int) (_vvvvvvvvvvvv2-1);
...
{
final int step418 = 1;
final int limit418 = (int) (_vvvvvvvvvvvv1-1);
...
_gsquare = mostCurrent._vvvvvvvvvvvvv1[_rowloop][_colloop];
...
_square.Initialize((int) (_gsquare._vvvv0._vv2-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvv0._vv3-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvv0._vv2+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvv0._vv3+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 488;BA.debugLine="canv.DrawRect(square, Colors.LightGray, True, 1dip)";
mostCurrent._vvvvvvvvvvv1.DrawRect((android.graphics.Rect)(_square.getObject()),anywheresoftware.b4a.keywords.Common.Colors.LightGray,anywheresoftware.b4a.keywords.Common.True,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))));
...
_square.Initialize((int) (_gsquare._vvvvv1._vv2-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv1._vv3-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv1._vv2+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv1._vv3+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
...
_square.Initialize((int) (_gsquare._vvvvv2._vv2-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv2._vv3-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv2._vv2+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv2._vv3+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
...
_square.Initialize((int) (_gsquare._vvvvv3._vv2-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv3._vv3-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv3._vv2+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_gsquare._vvvvv3._vv3+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
...
public static String  _vvvvvvvvvvvvvv3(pineysoft.squarepaddocks.gamesquare _square) throws Exception{
...
if (_square._vvvvv7.IsInitialized()) { 
 //BA.debugLineNum = 1175;BA.debugLine="square.fillLabel.SetBackgroundImage(Null)";
_square._vvvvv7.SetBackgroundImage((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null));
 }else {
...
_fillrect.Initialize((int) (_square._vvvv0._vv2+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_square._vvvv0._vv3+anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_square._vvvvv3._vv2-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))),(int) (_square._vvvvv3._vv3-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 //BA.debugLineNum = 1178;BA.debugLine="canv.DrawRect(fillRect,SPConstants.BG_COLOUR,True,1dip)";
mostCurrent._vvvvvvvvvvv1.DrawRect((android.graphics.Rect)(_fillrect.getObject()),_v6._bg_colour,anywheresoftware.b4a.keywords.Common.True,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))));
 };
 //BA.debugLineNum = 1180;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvvv5(pineysoft.squarepaddocks.gamesquare _square,pineysoft.squarepaddocks.player _currplayer) throws Exception{
anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper _fillrect = null;
...
if (_currplayer._vvv1.IsInitialized()) { 
...
_square._vvvvv7.SetBackgroundImage((android.graphics.Bitmap)(_currplayer._vvv1.getObject()));
 }else {
...
_lblnew.SetBackgroundImage((android.graphics.Bitmap)(_currplayer._vvv1.getObject()));
...
mostCurrent._vvvvvvvvvvv1.DrawRect((android.graphics.Rect)(_fillrect.getObject()),_currplayer._vv0,anywheresoftware.b4a.keywords.Common.True,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (1))));
 };
 //BA.debugLineNum = 1169;BA.debugLine="End Sub";
return "";
}
public static anywheresoftware.b4a.objects.collections.List  _vvvvvvvvvvvv4(int _checksides) throws Exception{
...
final int limit1048 = (int) (_vvvvvvvvvvvv2-1);
...
final int limit1049 = (int) (_vvvvvvvvvvvv1-1);
...
if (mostCurrent._vvvvvvvvvvvvv1[_row][_col]._vvvvv6==_checksides) { 
 //BA.debugLineNum = 1240;BA.debugLine="foundSquares.Add(gameSquares(row,col))";
_foundsquares.Add((Object)(mostCurrent._vvvvvvvvvvvvv1[_row][_col]));
 };
 }
};
 }
...
public static pineysoft.squarepaddocks.gamesquare  _vvvvvvvvvv5(int _xpos,int _ypos) throws Exception{
int _colloop = 0;
int _rowloop = 0;
int _foundrow = 0;
int _foundcol = 0;
...
final int limit1008 = (int) (_vvvvvvvvvvvv2-1);
...
_square = mostCurrent._vvvvvvvvvvvvv1[_rowloop][(int) (0)];
 //BA.debugLineNum = 1191;BA.debugLine="If square.TopLeft.pos2 > ypos Then";
if (_square._vvvv0._vv3>_ypos) { 
...
_square = mostCurrent._vvvvvvvvvvvvv1[_foundrow][_colloop];
 //BA.debugLineNum = 1205;BA.debugLine="If square.TopLeft.pos1 > xpos  Then";
if (_square._vvvv0._vv2>_xpos) { 
...
mostCurrent._vvvvvvvvv3.Stop((android.view.View)(mostCurrent._pnlstartscreen.getObject()));
...
mostCurrent._vvvvvvvvv4.Stop((android.view.View)(mostCurrent._pnlbase.getObject()));
...
public static anywheresoftware.b4a.objects.collections.List  _vvvvvvvvvvvvvv1() throws Exception{
...
_found2sides = _vvvvvvvvvvvv4((int) (2));
...
if (_checkedsquares.ContainsKey((Object)(BA.NumberToString(_square._vvvv7)+"-"+BA.NumberToString(_square._vvvv6)))==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 1001;BA.debugLine="checkSquare = gameSquares(square.rowPos, square.colPos)";
_checksquare = mostCurrent._vvvvvvvvvvvvv1[_square._vvvv7][_square._vvvv6];
...
_freeedges = _checksquare._vvv0(_excludeedgenum);
...
_freeedge = (int)(BA.ObjectToNumber(_checksquare._vvv0(_excludeedgenum).Get((int) (0))));
 };
 //BA.debugLineNum = 1014;BA.debugLine="If checkSquare.sidesTaken <> 2 Then";
if (_checksquare._vvvvv6!=2) { 
...
if (_chaincounter>1 && _checksquare._vvvv7==_startingsquare._vvvv7 && _checksquare._vvvv6==_startingsquare._vvvv6) { 
...
_checkedsquares.Put((Object)(BA.NumberToString(_checksquare._vvvv7)+"-"+BA.NumberToString(_checksquare._vvvv6)),(Object)(_checksquare));
...
if (mostCurrent._vvvvvvvvvvvvv1[_rowpos][_colpos]._vvvvv6==2) { 
 //BA.debugLineNum = 1057;BA.debugLine="checkSquare = gameSquares(rowPos,colPos)";
_checksquare = mostCurrent._vvvvvvvvvvvvv1[_rowpos][_colpos];
 }else {
...
if (_tempitem.square._vvvv7==_square._vvvv7 && _tempitem.square._vvvv6==_square._vvvv6) { 
...
_checkedsquares.Put((Object)(BA.NumberToString(_square._vvvv7)+"-"+BA.NumberToString(_square._vvvv6)),(Object)(_square));
 };
 }
;
...
public static int  _vvvvvvvvvvvvvv4(pineysoft.squarepaddocks.gamesquare _currentsquare,int _side) throws Exception{
pineysoft.squarepaddocks.gamesquare _checksquare = null;
...
_checksquare = _vvvvvvvvvvvvvv5(_currentsquare,_side);
...
if (true) return _checksquare._vvvvv6;
 }else {
...
public static anywheresoftware.b4a.objects.ConcreteViewWrapper  _vvvvvvvvvvvvv6(anywheresoftware.b4a.objects.ActivityWrapper _searchview,String _tag) throws Exception{
...
mostCurrent._vvvvvvvvvvvvv1 = new pineysoft.squarepaddocks.gamesquare[(int) (0)][];
{
int d0 = mostCurrent._vvvvvvvvvvvvv1.length;
int d1 = (int) (0);
for (int i0 = 0;i0 < d0;i0++) {
...
mostCurrent._vvvvvvvvvvvvvv6 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 38;BA.debugLine="Private gameWidth As Int = 7";
_vvvvvvvvvvvv1 = (int) (7);
 //BA.debugLineNum = 39;BA.debugLine="Private gameHeight As Int = 9";
_vvvvvvvvvvvv2 = (int) (9);
...
mostCurrent._vvvvvvvvvvv1 = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 44;BA.debugLine="Private players As List";
mostCurrent._vvvvvvvvvv6 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 45;BA.debugLine="Private playerImages As List";
mostCurrent._vvvvvvvvvvvvv7 = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 46;BA.debugLine="Private checkBoxImages As List";
mostCurrent._vvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.collections.List();
...
mostCurrent._vvvvvvv6 = new flm.b4a.animationplus.AnimationPlusWrapper();
 //BA.debugLineNum = 76;BA.debugLine="Dim anim2 As AnimationPlus";
mostCurrent._vvvvvvv0 = new flm.b4a.animationplus.AnimationPlusWrapper();
 //BA.debugLineNum = 77;BA.debugLine="Dim anim3 As AnimationPlus";
mostCurrent._vvvvvvvv2 = new flm.b4a.animationplus.AnimationPlusWrapper();
 //BA.debugLineNum = 78;BA.debugLine="Dim anim4 As AnimationPlus";
mostCurrent._vvvvvvvv4 = new flm.b4a.animationplus.AnimationPlusWrapper();
 //BA.debugLineNum = 79;BA.debugLine="Dim anim5 As AnimationPlus";
mostCurrent._vvvvvvvv6 = new flm.b4a.animationplus.AnimationPlusWrapper();
 //BA.debugLineNum = 80;BA.debugLine="Dim anim6 As AnimationPlus";
mostCurrent._vvvvvvvv0 = new flm.b4a.animationplus.AnimationPlusWrapper();
...
mostCurrent._vvvvvvvvv6 = new flm.b4a.animationplus.AnimationPlusWrapper();
 //BA.debugLineNum = 83;BA.debugLine="Dim animPanel2 As AnimationPlus";
mostCurrent._vvvvvvvvv0 = new flm.b4a.animationplus.AnimationPlusWrapper();
...
mostCurrent._vvvvvvvvv4 = new flm.b4a.animationplus.AnimationPlusWrapper();
...
_vvvvvvvvvvvvv4 = (int)(Double.parseDouble(mostCurrent._spnplayers.getSelectedItem()));
 //BA.debugLineNum = 416;BA.debugLine="numberOfDroids = spnDroids.SelectedItem";
_vvvvvvvvvvvvv5 = (int)(Double.parseDouble(mostCurrent._spndroids.getSelectedItem()));
 //BA.debugLineNum = 417;BA.debugLine="gameHeight = sbRows.Value + 4";
_vvvvvvvvvvvv2 = (int) (mostCurrent._sbrows.getValue()+4);
 //BA.debugLineNum = 418;BA.debugLine="gameWidth = sbColumns.Value + 4";
_vvvvvvvvvvvv1 = (int) (mostCurrent._sbcolumns.getValue()+4);
 //BA.debugLineNum = 419;BA.debugLine="columnSpacing = panel1.Width / (gameWidth + 1)";
_vvvvvvvvvvvv7 = (int) (mostCurrent._panel1.getWidth()/(double)(_vvvvvvvvvvvv1+1));
 //BA.debugLineNum = 420;BA.debugLine="rowSpacing = panel1.Height / (gameHeight + 1)";
_vvvvvvvvvvvv0 = (int) (mostCurrent._panel1.getHeight()/(double)(_vvvvvvvvvvvv2+1));
 //BA.debugLineNum = 421;BA.debugLine="canv.Initialize(panel1)";
mostCurrent._vvvvvvvvvvv1.Initialize((android.view.View)(mostCurrent._panel1.getObject()));
 //BA.debugLineNum = 422;BA.debugLine="gameTurns.Initialize";
mostCurrent._vvvvvvvvvvvvvv6.Initialize();
...
_vvvvvvvvvvv6 = _v5.Load(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Giggle1.mp3");
...
mostCurrent._vvvvvvv6.Stop((android.view.View)(mostCurrent._icon1.getObject()));
 //BA.debugLineNum = 234;BA.debugLine="anim2.Stop(icon2)";
mostCurrent._vvvvvvv0.Stop((android.view.View)(mostCurrent._icon2.getObject()));
 //BA.debugLineNum = 235;BA.debugLine="anim3.Stop(icon3)";
mostCurrent._vvvvvvvv2.Stop((android.view.View)(mostCurrent._icon3.getObject()));
 //BA.debugLineNum = 236;BA.debugLine="anim4.Stop(icon4)";
mostCurrent._vvvvvvvv4.Stop((android.view.View)(mostCurrent._icon4.getObject()));
 //BA.debugLineNum = 237;BA.debugLine="anim5.Stop(icon5)";
mostCurrent._vvvvvvvv6.Stop((android.view.View)(mostCurrent._icon5.getObject()));
 //BA.debugLineNum = 238;BA.debugLine="anim6.Stop(icon6)";
mostCurrent._vvvvvvvv0.Stop((android.view.View)(mostCurrent._icon6.getObject()));
...
_vvvvvvvvvvvvvvv2(mostCurrent._icon1,(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (75),mostCurrent.activityBA)-(mostCurrent._icon1.getWidth()/(double)2)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA));
...
_vvvvvvvvvvvvvvv2(mostCurrent._icon2,(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (25),mostCurrent.activityBA)-(mostCurrent._icon2.getWidth()/(double)2)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA));
 //BA.debugLineNum = 243;BA.debugLine="SetIconAtPosition(icon3,50%x-(icon3.Width/2),25%y)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon3,(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)-(mostCurrent._icon3.getWidth()/(double)2)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA));
 //BA.debugLineNum = 244;BA.debugLine="SetIconAtPosition(icon4,50%x-(icon4.Width/2),45%y)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon4,(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)-(mostCurrent._icon4.getWidth()/(double)2)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA));
 //BA.debugLineNum = 245;BA.debugLine="SetIconAtPosition(icon5,25%x-(icon5.Width/2),25%y)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon5,(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (25),mostCurrent.activityBA)-(mostCurrent._icon5.getWidth()/(double)2)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA));
 //BA.debugLineNum = 246;BA.debugLine="SetIconAtPosition(icon6,75%x-(icon6.Width/2),45%y)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon6,(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (75),mostCurrent.activityBA)-(mostCurrent._icon6.getWidth()/(double)2)),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA));
...
_vvvvvvv4 = anywheresoftware.b4a.keywords.Common.True;
...
public static String  _vvvvvv5() throws Exception{
...
mostCurrent._vvvvvvvvvvvvv7.Initialize();
...
mostCurrent._vvvvvvvvvvvvv7.Add((Object)(_bm.getObject()));
...
mostCurrent._vvvvvvvvvvvv3.Initialize();
...
mostCurrent._vvvvvvvvvvvv3.Add((Object)(_bm.getObject()));
...
mostCurrent._vvvvvvvvvvvv3.Add((Object)(_bm2.getObject()));
...
public static String  _vvvvvvvvvvv5(pineysoft.squarepaddocks.player _currplayer) throws Exception{
...
_vvvvvvvvvvvvvvv4(_found3s,_currplayer);
...
_sideclaimed = _vvvvvvvvvvvvvvv6(_found2s,anywheresoftware.b4a.keywords.Common.True);
 };
 };
 };
...
if (_vvvvvvvvvvvvvvv6(_found0s,_forceanyalways)==anywheresoftware.b4a.keywords.Common.False) { 
...
_sideclaimed = _vvvvvvvvvvvvvvv6(_found0s,anywheresoftware.b4a.keywords.Common.True);
 }else {
...
if (_vvvvvvvvvvvvvvv6(_found1s,_forceanyalways)==anywheresoftware.b4a.keywords.Common.False) { 
...
_sideclaimed = _vvvvvvvvvvvvvvv6(_found1s,anywheresoftware.b4a.keywords.Common.True);
 };
 }else {
...
if (_vvvvvvvvvvvvvvv6(_found2s,_forceanyalways)==anywheresoftware.b4a.keywords.Common.False) { 
...
_vvvvvvvvvvvvvvv6(_found2s,anywheresoftware.b4a.keywords.Common.True);
 };
 };
 };
...
public static String  _vvvvvvvvvvvvvvv0(pineysoft.squarepaddocks.gamesquare _currentsquare,int _side,boolean _marktaken) throws Exception{
int _foundcol = 0;
int _foundrow = 0;
int _updateside = 0;
...
_foundrow = _currentsquare._vvvv7;
 //BA.debugLineNum = 595;BA.debugLine="foundCol = currentSquare.ColPos";
_foundcol = _currentsquare._vvvv6;
...
mostCurrent._vvvvvvvvvvvvv1[_foundrow][_foundcol]._vvvv2(_updateside,_marktaken);
 };
 //BA.debugLineNum = 633;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvv2(pineysoft.squarepaddocks.gamesquare _currentsquare,int _side) throws Exception{
...
_vvvvvvvvvvvvvvv0(_currentsquare,_side,anywheresoftware.b4a.keywords.Common.True);
...
_vvvvvvvvvvvvv2 = new anywheresoftware.b4a.objects.collections.List();
...
public static String  _vvvvvvvvvvvvvvvv1(pineysoft.squarepaddocks.turn _lastturn,pineysoft.squarepaddocks.player _currplayer) throws Exception{
...
if (_lastturn._vvvvv0._vvvvv6==4) { 
 //BA.debugLineNum = 1382;BA.debugLine="currPlayer.Score = currPlayer.Score - 1";
_currplayer._vv7 = (int) (_currplayer._vv7-1);
 //BA.debugLineNum = 1383;BA.debugLine="EmptyTheSquare(lastTurn.Square)";
_vvvvvvvvvvvvvv3(_lastturn._vvvvv0);
 };
 //BA.debugLineNum = 1387;BA.debugLine="lastTurn.Square.RemoveSide(canv, lastTurn.Edge)";
_lastturn._vvvvv0._vvvv4(mostCurrent._vvvvvvvvvvv1,_lastturn._vvvvvv1);
 //BA.debugLineNum = 1388;BA.debugLine="MarkOtherSide(lastTurn.Square,lastTurn.Edge,False)";
_vvvvvvvvvvvvvvv0(_lastturn._vvvvv0,_lastturn._vvvvvv1,anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 1391;BA.debugLine="gameTurns.RemoveAt(gameTurns.Size - 1)";
mostCurrent._vvvvvvvvvvvvvv6.RemoveAt((int) (mostCurrent._vvvvvvvvvvvvvv6.getSize()-1));
 //BA.debugLineNum = 1394;BA.debugLine="If gameTurns.Size > 0 Then";
if (mostCurrent._vvvvvvvvvvvvvv6.getSize()>0) { 
 //BA.debugLineNum = 1395;BA.debugLine="lastTurn = gameTurns.Get(gameTurns.Size - 1)";
_lastturn = (pineysoft.squarepaddocks.turn)(mostCurrent._vvvvvvvvvvvvvv6.Get((int) (mostCurrent._vvvvvvvvvvvvvv6.getSize()-1)));
 //BA.debugLineNum = 1396;BA.debugLine="lastTurn.Square.RedrawSide(canv, lastTurn.Edge)";
_lastturn._vvvvv0._vvvv3(mostCurrent._vvvvvvvvvvv1,_lastturn._vvvvvv1);
 };
...
_vvvvvvv7 = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 259;BA.debugLine="start2 = Rnd(0,100%y)";
_vvvvvvvv1 = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 260;BA.debugLine="start3 = Rnd(0,100%y)";
_vvvvvvvv3 = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 261;BA.debugLine="start4 = Rnd(0,100%y)";
_vvvvvvvv5 = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 262;BA.debugLine="start5 = Rnd(0,100%y)";
_vvvvvvvv7 = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 263;BA.debugLine="start6 = Rnd(0,100%y)";
_vvvvvvvvv1 = anywheresoftware.b4a.keywords.Common.Rnd((int) (0),anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (100),mostCurrent.activityBA));
 //BA.debugLineNum = 265;BA.debugLine="SetIconAtPosition(icon1,-(icon1.Width),start1)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon1,(int) (-(mostCurrent._icon1.getWidth())),_vvvvvvv7);
 //BA.debugLineNum = 266;BA.debugLine="SetIconAtPosition(icon2,100%x,start2)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon2,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_vvvvvvvv1);
 //BA.debugLineNum = 267;BA.debugLine="SetIconAtPosition(icon3,-(icon3.Width),start3)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon3,(int) (-(mostCurrent._icon3.getWidth())),_vvvvvvvv3);
 //BA.debugLineNum = 268;BA.debugLine="SetIconAtPosition(icon4,100%x,start4)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon4,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_vvvvvvvv5);
 //BA.debugLineNum = 269;BA.debugLine="SetIconAtPosition(icon5,-(icon5.Width),start5)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon5,(int) (-(mostCurrent._icon5.getWidth())),_vvvvvvvv7);
 //BA.debugLineNum = 270;BA.debugLine="SetIconAtPosition(icon6,100%x,start6)";
_vvvvvvvvvvvvvvv2(mostCurrent._icon6,anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA),_vvvvvvvvv1);
 //BA.debugLineNum = 271;BA.debugLine="End Sub";
return "";
}
public static boolean  _vvvvvv0() throws Exception{
...
mostCurrent._vvvvvvv6.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (-(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (75),mostCurrent.activityBA)+(mostCurrent._icon1.getWidth()/(double)2))),(float) (_vvvvvvv7-anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA)));
 //BA.debugLineNum = 176;BA.debugLine="anim1.Duration = 700";
mostCurrent._vvvvvvv6.setDuration((long) (700));
 //BA.debugLineNum = 177;BA.debugLine="anim1.PersistAfter = True";
mostCurrent._vvvvvvv6.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._vvvvvvv0.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (75),mostCurrent.activityBA)+(mostCurrent._icon2.getWidth()/(double)2)),(float) (_vvvvvvvv1-anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA)));
 //BA.debugLineNum = 180;BA.debugLine="anim2.Duration = 700";
mostCurrent._vvvvvvv0.setDuration((long) (700));
 //BA.debugLineNum = 181;BA.debugLine="anim2.PersistAfter = True";
mostCurrent._vvvvvvv0.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._vvvvvvvv2.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (-(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)+(mostCurrent._icon3.getWidth()/(double)2))),(float) (_vvvvvvvv3-anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA)));
 //BA.debugLineNum = 184;BA.debugLine="anim3.Duration = 700";
mostCurrent._vvvvvvvv2.setDuration((long) (700));
 //BA.debugLineNum = 185;BA.debugLine="anim3.PersistAfter = True";
mostCurrent._vvvvvvvv2.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._vvvvvvvv4.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA)+(mostCurrent._icon4.getWidth()/(double)2)),(float) (_vvvvvvvv5-anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA)));
 //BA.debugLineNum = 188;BA.debugLine="anim4.Duration = 700";
mostCurrent._vvvvvvvv4.setDuration((long) (700));
 //BA.debugLineNum = 189;BA.debugLine="anim4.PersistAfter = True";
mostCurrent._vvvvvvvv4.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._vvvvvvvv6.InitializeTranslate(mostCurrent.activityBA,"",(float) (0),(float) (0),(float) (-(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (25),mostCurrent.activityBA)+(mostCurrent._icon5.getWidth()/(double)2))),(float) (_vvvvvvvv7-anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (25),mostCurrent.activityBA)));
 //BA.debugLineNum = 192;BA.debugLine="anim5.Duration = 700";
mostCurrent._vvvvvvvv6.setDuration((long) (700));
 //BA.debugLineNum = 193;BA.debugLine="anim5.PersistAfter = True";
mostCurrent._vvvvvvvv6.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._vvvvvvvv0.InitializeTranslate(mostCurrent.activityBA,"LastIconEnd",(float) (0),(float) (0),(float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (25),mostCurrent.activityBA)+(mostCurrent._icon6.getWidth()/(double)2)),(float) (_vvvvvvvvv1-anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (45),mostCurrent.activityBA)));
 //BA.debugLineNum = 196;BA.debugLine="anim6.Duration = 700";
mostCurrent._vvvvvvvv0.setDuration((long) (700));
 //BA.debugLineNum = 197;BA.debugLine="anim6.PersistAfter = True";
mostCurrent._vvvvvvvv0.setPersistAfter(anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._vvvvvvvvv6.Stop((android.view.View)(mostCurrent._pnlselectionleft.getObject()));
...
mostCurrent._vvvvvvvvv0.Stop((android.view.View)(mostCurrent._pnlselectionright.getObject()));
...
public static String  _vvvvvvvvvvvvvvv2(anywheresoftware.b4a.objects.ImageViewWrapper _icon,int _left,int _top) throws Exception{
...
public static pineysoft.squarepaddocks.gamesquare  _vvvvvvvvvvvvvv5(pineysoft.squarepaddocks.gamesquare _square,int _side) throws Exception{
...
if (_currentsquare._vvvv1(_v6._left_side)==anywheresoftware.b4a.keywords.Common.False) { 
...
if (_currentsquare._vvvv6==0 || mostCurrent._vvvvvvvvvvvvv1[_currentsquare._vvvv7][(int) (_currentsquare._vvvv6-1)]._vvvvv6==2) { 
 //BA.debugLineNum = 818;BA.debugLine="closeSide = SPConstants.LEFT_SIDE";
_closeside = _v6._left_side;
 };
 }else if(_currentsquare._vvvv1(_v6._right_side)==anywheresoftware.b4a.keywords.Common.False) { 
...
if (_currentsquare._vvvv6==_vvvvvvvvvvvv1-1 || mostCurrent._vvvvvvvvvvvvv1[_currentsquare._vvvv7][(int) (_currentsquare._vvvv6+1)]._vvvvv6==2) { 
 //BA.debugLineNum = 822;BA.debugLine="closeSide = SPConstants.RIGHT_SIDE";
_closeside = _v6._right_side;
 };
 }else if(_currentsquare._vvvv1(_v6._top_side)==anywheresoftware.b4a.keywords.Common.False) { 
...
if (_currentsquare._vvvv7==0 || mostCurrent._vvvvvvvvvvvvv1[(int) (_currentsquare._vvvv7-1)][_currentsquare._vvvv6]._vvvvv6==2) { 
 //BA.debugLineNum = 826;BA.debugLine="closeSide = SPConstants.TOP_SIDE";
_closeside = _v6._top_side;
 };
 }else if(_currentsquare._vvvv1(_v6._bottom_side)==anywheresoftware.b4a.keywords.Common.False) { 
...
if (_currentsquare._vvvv7==_vvvvvvvvvvvv2-1 || mostCurrent._vvvvvvvvvvvvv1[(int) (_currentsquare._vvvv7+1)][_currentsquare._vvvv6]._vvvvv6==2) { 
...
_vvvvvvvvvv0(mostCurrent._vvvvvvvvvvv1,_currentsquare,_closeside);
 //BA.debugLineNum = 840;BA.debugLine="currentSquare.TakeSide(canv,closeSide)";
_currentsquare._vvvv5(mostCurrent._vvvvvvvvvvv1,_closeside);
 //BA.debugLineNum = 843;BA.debugLine="MarkOtherSide2(currentSquare, closeSide)";
_vvvvvvvvvvv2(_currentsquare,_closeside);
 }
;
 //BA.debugLineNum = 847;BA.debugLine="End Sub";
return "";
}
public static boolean  _vvvvvvvvvvvvvvv4(anywheresoftware.b4a.objects.collections.List _found3s,pineysoft.squarepaddocks.player _currplayer) throws Exception{
int _closeside = 0;
pineysoft.squarepaddocks.gamesquare _currentsquare = null;
...
anywheresoftware.b4a.keywords.Common.Log("Row: "+BA.NumberToString(_currentsquare._vvvv7)+" Column: "+BA.NumberToString(_currentsquare._vvvv6));
...
public static boolean  _vvvvvvvvvvvvvvv6(anywheresoftware.b4a.objects.collections.List _foundvalids,boolean _forceany) throws Exception{
int _rndnum = 0;
...
if (_foundsquare._vvvv1(_rndside)==anywheresoftware.b4a.keywords.Common.False) { 
...
_sides = _vvvvvvvvvvvvvv4(_foundsquare,_rndside);
...
_vvvvvvvvvv0(mostCurrent._vvvvvvvvvvv1,_foundsquare,_rndside);
 //BA.debugLineNum = 886;BA.debugLine="foundSquare.TakeSide(canv, rndSide)";
_foundsquare._vvvv5(mostCurrent._vvvvvvvvvvv1,_rndside);
 //BA.debugLineNum = 888;BA.debugLine="MarkOtherSide2(foundSquare, rndSide)";
_vvvvvvvvvvv2(_foundsquare,_rndside);
 };
 };
...
public static boolean  _vvvvvvvvvvvvvvv7() throws Exception{
int _rndside = 0;
pineysoft.squarepaddocks.gamesquare _foundsquare = null;
anywheresoftware.b4a.objects.collections.List _chainlist = null;
...
_edges = _foundsquare._vvv0((int) (-1));
...
public static boolean  _vvvvvvvvvvvvvvvv3(anywheresoftware.b4a.objects.collections.List _foundvalids,boolean _forceany) throws Exception{
int _rndnum = 0;
boolean _foundside = false;
int _rndside = 0;
int _loopcount = 0;
...
final int limit1072 = (int) (_vvvvvvvvvvvvv4-1);
...
_vvvvvvvvvv7 = (short) (_vvvvvvvvvv7+1);
 //BA.debugLineNum = 583;BA.debugLine="If currentPlayer > numberOfPlayers - 1 Then currentPlayer = 0";
if (_vvvvvvvvvv7>_vvvvvvvvvvvvv4-1) { 
_vvvvvvvvvv7 = (short) (0);};
 //BA.debugLineNum = 584;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvvv7(pineysoft.squarepaddocks.player _currplayer) throws Exception{
...
_temp = _vvvvvvvvvvvvv6((anywheresoftware.b4a.objects.ActivityWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.objects.ActivityWrapper(), (anywheresoftware.b4a.BALayout)(mostCurrent._pnlbase.getObject())),"P"+BA.NumberToString((_vvvvvvvvvv7+1)));
...
if (_currplayer._vvv2==_v6._player_type_human) { 
 //BA.debugLineNum = 558;BA.debugLine="lbl.Text = \"Player \" & (currentPlayer + 1) & \" : \" & currPlayer.Score";
_lbl.setText((Object)("Player "+BA.NumberToString((_vvvvvvvvvv7+1))+" : "+BA.NumberToString(_currplayer._vv7)));
 }else {
 //BA.debugLineNum = 560;BA.debugLine="lbl.Text = \"Droid \" & (currentPlayer + 1) & \" : \" & currPlayer.Score";
_lbl.setText((Object)("Droid "+BA.NumberToString((_vvvvvvvvvv7+1))+" : "+BA.NumberToString(_currplayer._vv7)));
 };
 };
 //BA.debugLineNum = 563;BA.debugLine="End Sub";
return "";
}
public static String  _vvvvvvvvvv0(anywheresoftware.b4a.objects.drawable.CanvasWrapper _cnv,pineysoft.squarepaddocks.gamesquare _currentsquare,int _chosenside) throws Exception{
...
_lastturn._vvvvv0._vvv7(mostCurrent._vvvvvvvvvvv1,_lastturn._vvvvvv1,anywheresoftware.b4a.keywords.Common.Colors.LightGray);
 };
 //BA.debugLineNum = 576;BA.debugLine="newTurn.Initialize(currentSquare, chosenSide, currentPlayer)";
_newturn._initialize(mostCurrent.activityBA,_currentsquare,_chosenside,(int) (_vvvvvvvvvv7));
 //BA.debugLineNum = 579;BA.debugLine="gameTurns.Add(newTurn)";
mostCurrent._vvvvvvvvvvvvvv6.Add((Object)(_newturn));
