...
public int _vvvv6 = 0;
public int _vvvv7 = 0;
public pineysoft.squarepaddocks.point _vvvv0 = null;
public pineysoft.squarepaddocks.point _vvvvv1 = null;
public pineysoft.squarepaddocks.point _vvvvv2 = null;
public pineysoft.squarepaddocks.point _vvvvv3 = null;
public char[] _vvvvv4 = null;
...
public int  _vvv5(pineysoft.squarepaddocks.point _xypos) throws Exception{
double _deltax = 0;
double _deltay = 0;
double _deg = 0;
...
_deltax = _vvvvv1._vv2-_xypos._vv2;
 //BA.debugLineNum = 76;BA.debugLine="deltaY = TopRight.Pos2 - xypos.Pos2";
_deltay = _vvvvv1._vv3-_xypos._vv3;
...
_vvvvv7 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 14;BA.debugLine="End Sub";
return "";
}
public String  _vvv6(anywheresoftware.b4a.objects.drawable.CanvasWrapper _cnv,pineysoft.squarepaddocks.point _startpoint,pineysoft.squarepaddocks.point _endpoint,int _color,int _direction) throws Exception{
...
_line.Initialize((int) (_startpoint._vv2-__c.DipToCurrent((int) (2))),(int) (_startpoint._vv3+__c.DipToCurrent((int) (4))),(int) (_endpoint._vv2+__c.DipToCurrent((int) (2))),(int) (_endpoint._vv3-__c.DipToCurrent((int) (4))));
 }else {
...
_line.Initialize((int) (_startpoint._vv2+__c.DipToCurrent((int) (4))),(int) (_startpoint._vv3-__c.DipToCurrent((int) (2))),(int) (_endpoint._vv2-__c.DipToCurrent((int) (4))),(int) (_endpoint._vv3+__c.DipToCurrent((int) (2))));
 };
...
public String  _vvv7(anywheresoftware.b4a.objects.drawable.CanvasWrapper _cnv,int _side,int _color) throws Exception{
...
_vvv6(_cnv,_startpoint,_endpoint,_color,_direction);
 //BA.debugLineNum = 174;BA.debugLine="End Sub";
return "";
}
public anywheresoftware.b4a.objects.collections.List  _vvv0(int _exclude) throws Exception{
...
if (_vvvvv4[_iloop]==BA.ObjectToChar("O")) { 
...
_vvvvv4[(int) (0)] = BA.ObjectToChar("O");
 //BA.debugLineNum = 25;BA.debugLine="sides(1) = \"O\"";
_vvvvv4[(int) (1)] = BA.ObjectToChar("O");
 //BA.debugLineNum = 26;BA.debugLine="sides(2) = \"O\"";
_vvvvv4[(int) (2)] = BA.ObjectToChar("O");
 //BA.debugLineNum = 27;BA.debugLine="sides(3) = \"O\"";
_vvvvv4[(int) (3)] = BA.ObjectToChar("O");
 //BA.debugLineNum = 29;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvv1(int _side) throws Exception{
...
if (true) return _vvvvv4[_side]==_v6._side_taken;
 //BA.debugLineNum = 103;BA.debugLine="End Sub";
return false;
}
public String  _vvvv2(int _side,boolean _marktaken) throws Exception{
...
public String  _vvvv3(anywheresoftware.b4a.objects.drawable.CanvasWrapper _cnv,int _side) throws Exception{
...
_vvv7(_cnv,_side,_v6._current_side_colour);
 //BA.debugLineNum = 183;BA.debugLine="End Sub";
return "";
}
public String  _vvvv4(anywheresoftware.b4a.objects.drawable.CanvasWrapper _cnv,int _side) throws Exception{
...
_vvv7(_cnv,_side,_v6._bg_colour);
 //BA.debugLineNum = 178;BA.debugLine="MarkSideTaken(side,False)";
_vvvv2(_side,__c.False);
 //BA.debugLineNum = 179;BA.debugLine="End Sub";
return "";
}
public String  _vvvv5(anywheresoftware.b4a.objects.drawable.CanvasWrapper _cnv,int _side) throws Exception{
