...
public class wallpaperservice extends android.app.Service {
	...
	public void onCreate() {
        mostCurrent = this;
        if (processBA == null) {
		    processBA = new BA(this, null, null, "anywheresoftware.b4a.samples.livewallpaperimage", "anywheresoftware.b4a.samples.livewallpaperimage.wallpaperservice");
            try {
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			processBA.raiseEvent2(null, true, "CREATE", true, "anywheresoftware.b4a.samples.livewallpaperimage.wallpaperservice", processBA, _service);
		}
...
public anywheresoftware.b4a.samples.livewallpaperimage.main _main = null;
public static String  _lwm_offsetchanged(anywheresoftware.b4a.objects.WallpaperInternalService.LWEngine _engine) throws Exception{
 ...
 //BA.debugLineNum = 38;BA.debugLine="image = LoadBitmap(File.DirAssets, \"drawboardportrait_complete.png\")";
_image = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"drawboardportrait_complete.png");
 //BA.debugLineNum = 39;BA.debugLine="resized = ResizeImage(image, Engine.FullWallpaperWidth, Engine.FullWallpaperHeight)";
_resized = _resizeimage(_image,_engine.getFullWallpaperWidth(),_engine.getFullWallpaperHeight());
 //BA.debugLineNum = 40;BA.debugLine="If resized.IsInitialized Then";
if (_resized.IsInitialized()) { 
 //BA.debugLineNum = 41;BA.debugLine="Engine.Rect.Left = -Engine.CurrentOffsetX";
_engine.Rect.setLeft((int) (-_engine.getCurrentOffsetX()));
 //BA.debugLineNum = 42;BA.debugLine="Engine.Rect.Top = -Engine.CurrentOffsetY";
_engine.Rect.setTop((int) (-_engine.getCurrentOffsetY()));
 //BA.debugLineNum = 43;BA.debugLine="Engine.Rect.Right = -Engine.CurrentOffsetX + Engine.FullWallpaperWidth";
_engine.Rect.setRight((int) (-_engine.getCurrentOffsetX()+_engine.getFullWallpaperWidth()));
 //BA.debugLineNum = 44;BA.debugLine="Engine.Rect.Bottom = -Engine.CurrentOffsetY + Engine.FullWallpaperHeight";
_engine.Rect.setBottom((int) (-_engine.getCurrentOffsetY()+_engine.getFullWallpaperHeight()));
 //BA.debugLineNum = 45;BA.debugLine="Engine.Canvas.DrawBitmap(resized, Null, Engine.Rect)";
_engine.getCanvas().DrawBitmap((android.graphics.Bitmap)(_resized.getObject()),(android.graphics.Rect)(anywheresoftware.b4a.keywords.Common.Null),(android.graphics.Rect)(_engine.Rect.getObject()));
 ...
 //BA.debugLineNum = 47;BA.debugLine="Engine.Canvas.DrawColor(Colors.Black)";
_engine.getCanvas().DrawColor(anywheresoftware.b4a.keywords.Common.Colors.Black);
 //BA.debugLineNum = 48;BA.debugLine="Engine.Canvas.DrawText(\"No image selected\", 120dip, 120dip, Typeface.DEFAULT_BOLD, 30, Colors.White, \"LEFT\")";
_engine.getCanvas().DrawText(processBA,"No image selected",(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (120))),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (120))),anywheresoftware.b4a.keywords.Common.Typeface.DEFAULT_BOLD,(float) (30),anywheresoftware.b4a.keywords.Common.Colors.White,BA.getEnumFromString(android.graphics.Paint.Align.class,"LEFT"));
 ...
 //BA.debugLineNum = 50;BA.debugLine="Engine.RefreshAll";
_engine.RefreshAll();
...
public static String  _lwm_tick(anywheresoftware.b4a.objects.WallpaperInternalService.LWEngine _engine) throws Exception{
 //BA.debugLineNum = 89;BA.debugLine="Sub lwm_Tick (Engine As LWEngine)";
 //BA.debugLineNum = 91;BA.debugLine="If y > 0 Then";
if (_y>0) { 
 //BA.debugLineNum = 92;BA.debugLine="y = y - vy";
_y = (int) (_y-_vy);
 //BA.debugLineNum = 94;BA.debugLine="Engine.Rect.Top = y";
_engine.Rect.setTop(_y);
 //BA.debugLineNum = 95;BA.debugLine="Engine.Rect.Left = x";
_engine.Rect.setLeft(_x);
 //BA.debugLineNum = 96;BA.debugLine="Engine.Rect.Bottom = y + boxsize";
_engine.Rect.setBottom((int) (_y+_boxsize));
 //BA.debugLineNum = 97;BA.debugLine="Engine.Rect.Right = x + boxsize";
_engine.Rect.setRight((int) (_x+_boxsize));
 //BA.debugLineNum = 99;BA.debugLine="Engine.Canvas.DrawCircle(x,y,5dip, Colors.Black,True, 2dip) 'Draw the new smiley";
_engine.getCanvas().DrawCircle((float) (_x),(float) (_y),(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))),anywheresoftware.b4a.keywords.Common.Colors.Black,anywheresoftware.b4a.keywords.Common.True,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 //BA.debugLineNum = 100;BA.debugLine="Engine.Refresh(Engine.Rect)";
_engine.Refresh((android.graphics.Rect)(_engine.Rect.getObject()));
 }else {
 //BA.debugLineNum = 102;BA.debugLine="lwm.StopTicking";
_lwm.StopTicking();
 };
...
public static String  _lwm_touch(anywheresoftware.b4a.objects.WallpaperInternalService.LWEngine _engine,int _action,float _tx,float _ty) throws Exception{
 //BA.debugLineNum = 77;BA.debugLine="Sub lwm_Touch (Engine As LWEngine, Action As Int, tx As Float, ty As Float)";
 //BA.debugLineNum = 78;BA.debugLine="If Action <> 0 Then Return '0 is the value of Activity.ACTION_DOWN";
if (_action!=0) { 
if (true) return "";};
 //BA.debugLineNum = 79;BA.debugLine="x = tx";
_x = (int) (_tx);
 //BA.debugLineNum = 80;BA.debugLine="y = ty";
_y = (int) (_ty);
 //BA.debugLineNum = 82;BA.debugLine="Engine.Canvas.DrawCircle(tx, ty, 5dip, Colors.Black, True, 2dip)";
_engine.getCanvas().DrawCircle(_tx,_ty,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (5))),anywheresoftware.b4a.keywords.Common.Colors.Black,anywheresoftware.b4a.keywords.Common.True,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (2))));
 //BA.debugLineNum = 83;BA.debugLine="Engine.Refresh(Engine.Rect)";
_engine.Refresh((android.graphics.Rect)(_engine.Rect.getObject()));
 //BA.debugLineNum = 85;BA.debugLine="lwm.StartTicking(30) 'Start the wallpaper timer (30 milliseconds).";
...
_degrees = 0;
 //BA.debugLineNum = 16;BA.debugLine="Dim boxsize As Int = 40dip";
...
int _w = 0;
int _h = 0;
 //BA.debugLineNum = 53;BA.debugLine="Sub ResizeImage(original As Bitmap, TargetX As Int, TargetY As Int) As Bitmap";
 //BA.debugLineNum = 54;BA.debugLine="Dim origRatio As Float = original.Width / original.Height";
_origratio = (float) (_original.getWidth()/(double)_original.getHeight());
 //BA.debugLineNum = 55;BA.debugLine="Dim targetRatio As Float = TargetX / TargetY";
_targetratio = (float) (_targetx/(double)_targety);
 //BA.debugLineNum = 56;BA.debugLine="Dim scale As Float";
_scale = 0f;
 //BA.debugLineNum = 58;BA.debugLine="If targetRatio > origRatio Then";
if (_targetratio>_origratio) { 
 //BA.debugLineNum = 59;BA.debugLine="scale = TargetY / original.Height";
_scale = (float) (_targety/(double)_original.getHeight());
 }else {
 //BA.debugLineNum = 61;BA.debugLine="scale = TargetX / original.Width";
_scale = (float) (_targetx/(double)_original.getWidth());
 };
 //BA.debugLineNum = 64;BA.debugLine="Dim c As Canvas";
_c = new anywheresoftware.b4a.objects.drawable.CanvasWrapper();
 //BA.debugLineNum = 65;BA.debugLine="Dim b As Bitmap";
_b = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 66;BA.debugLine="b.InitializeMutable(TargetX, TargetY)";
_b.InitializeMutable(_targetx,_targety);
 //BA.debugLineNum = 67;BA.debugLine="c.Initialize2(b)";
_c.Initialize2((android.graphics.Bitmap)(_b.getObject()));
 //BA.debugLineNum = 69;BA.debugLine="c.DrawColor(Colors.LightGray)";
_c.DrawColor(anywheresoftware.b4a.keywords.Common.Colors.LightGray);
 //BA.debugLineNum = 70;BA.debugLine="Dim r As Rect";
_r = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.RectWrapper();
 //BA.debugLineNum = 71;BA.debugLine="Dim w = original.Width * scale, h = original.Height * scale As Int";
_w = (int) (_original.getWidth()*_scale);
_h = (int) (_original.getHeight()*_scale);
 //BA.debugLineNum = 72;BA.debugLine="r.Initialize(TargetX / 2 - w / 2, TargetY / 2 - h / 2, TargetX / 2 + w / 2, TargetY / 2+ h / 2)";
_r.Initialize((int) (_targetx/(double)2-_w/(double)2),(int) (_targety/(double)2-_h/(double)2),(int) (_targetx/(double)2+_w/(double)2),(int) (_targety/(double)2+_h/(double)2));
 //BA.debugLineNum = 73;BA.debugLine="c.DrawBitmap(original, Null, r)";
_c.DrawBitmap((android.graphics.Bitmap)(_original.getObject()),(android.graphics.Rect)(anywheresoftware.b4a.keywords.Common.Null),(android.graphics.Rect)(_r.getObject()));
 //BA.debugLineNum = 74;BA.debugLine="Return b";
if (true) return _b;
